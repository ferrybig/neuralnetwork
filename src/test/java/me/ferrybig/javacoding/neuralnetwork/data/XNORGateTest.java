...
public class XNORGateTest extends NeuralTest {
	...
	protected SupervisedTrainingSet[] getTestData() {
		return new SupervisedTrainingSet[]{
			...
			new SupervisedTrainingSet(new double[]{1,0}, new double[]{0}),
			new SupervisedTrainingSet(new double[]{0,1}, new double[]{0}),
			new SupervisedTrainingSet(new double[]{1,1}, new double[]{1}),
		};
	}
